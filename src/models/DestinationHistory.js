module.exports = function (app) {
    app.factory('DestinationHistory', function (CMSModelInterceptor,
                                                langService,
                                                _) {
        'ngInject';
        return function DestinationHistory(model) {
            var self = this;
            self.id = null;
            self.vsId = null;
            ...
            DestinationHistory.prototype.getTranslatedAction = function (reverse) {
