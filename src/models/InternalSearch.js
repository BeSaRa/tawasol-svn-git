module.exports = function (app) {
    app.factory('InternalSearch', function (CMSModelInterceptor,
        ...
        return function InternalSearch(model) {
             ...
             */
            InternalSearch.prototype.getRequiredFields = function () {
             ...
             * @returns {string}
             */
            InternalSearch.prototype.getNames = function (separator) {
             ...
             * @returns {string}
             */
            InternalSearch.prototype.getTranslatedName = function (reverse) {
             ...
             * @returns {string}
             */
            InternalSearch.prototype.getTranslatedStatus = function () {
             ...
             * @returns {string}
             */
            InternalSearch.prototype.getTranslatedGlobal = function () {
