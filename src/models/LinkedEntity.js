module.exports = function (app) {
    app.factory('LinkedEntity', function (CMSModelInterceptor, 
                                            langService,
                                          _) {
        'ngInject';
        return function LinkedEntity(model) {
            var self = this;
            self.id = null;
            self.vsId = null;
            ...
            LinkedEntity.prototype.getTranslatedActionBy = function (reverse) {
            ...
            LinkedEntity.prototype.allActions = function () {
                return [
            ...
            LinkedEntity.prototype.getTranslatedAction = function (reverse) {
            ...
            LinkedEntity.prototype.getTranslatedItemType = function(reverse){
                return langService.current === 'ar'
                    ? (reverse ? this.itemTypeInfo.enName : this.itemTypeInfo.arName)
                    : (reverse ? this.itemTypeInfo.arName : this.itemTypeInfo.enName);
            };

            CMSModelInterceptor.runEvent('LinkedEntity', 'init', this);
        }
    })
};