module.exports = function (app) {
    app.run(function (CMSModelInterceptor) {
        ...
        CMSModelInterceptor.whenSendModel(modelName, function (model) {
            ...
            model.updateActionStatus = model.updateActionStatus && model.updateActionStatus.hasOwnProperty('id') ? model.updateActionStatus.lookupKey : model.updateActionStatus;
            delete model.file;
            delete model.source;
