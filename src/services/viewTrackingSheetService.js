    ...
    app.service('viewTrackingSheetService', function (urlService,
            ...
            self.controllerMethod = {
                ...
                viewMergedLinkedDocumentHistoryEvents: function (mergedLinkedDocumentHistory, $event) {
                    var events = mergedLinkedDocumentHistory.hasOwnProperty('events') ? mergedLinkedDocumentHistory.events : mergedLinkedDocumentHistory;
                    ...
                    return dialog.showDialog({
                        ...
                        controllerAs: 'ctrl',
                        locals: {
                            mergedLinkedDocHistoryEvents: events,
                 ...
                 * @returns {promise}
                 */
                viewContentViewHistoryEvents: function (contentViewHistory, $event) {
                    var events = contentViewHistory.hasOwnProperty('events') ? contentViewHistory.events : contentViewHistory;

                    return dialog.showDialog({
                        template: cmsTemplate.getPopup('content-view-history-events'),
                        controller: 'contentViewHistoryEventsPopCtrl',
                        targetEvent: $event || false,
                        controllerAs: 'ctrl',
                        locals: {
                            contentViewHistoryEvents: events,
