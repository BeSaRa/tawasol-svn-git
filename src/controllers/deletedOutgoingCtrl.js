module.exports = function (app) {
    app.controller('deletedOutgoingCtrl', function (contextHelpService,
        ...
        self.viewDocument = function (correspondence, $event) {
            ...
            correspondence.viewFromDeletedQueue(self.gridActions, 'deletedOutgoing', $event, true)
                .then(function () {
        ...
        self.previewDocument = function (deletedOutgoing, $event) {
            ...
            correspondenceService.viewDeletedCorrespondence(deletedOutgoing, self.gridActions, true)
                .then(function () {
                    return self.reloadDeletedOutgoings(self.grid.page);
                })
                .catch(function () {
        ...
        self.removePermanentlyBulk = function ($event) {
            correspondenceService
                .removePermanentlyBulkCorrespondences(self.selectedDeletedOutgoings, $event)
                .then(function () {
                    self.reloadDeletedOutgoings(self.grid.page);
                });
        };
        ...
        self.gridActions = [
            ...
            // Remove Permanently
            {
                ...
                class: "action-green",
                permissionKey: 'DELETE_OUTGOING_PERMENANT',
                checkShow: function (action, model) {
                    return true;
                }
            },
