module.exports = function (app) {
    app.controller('searchIncomingCtrl', function (lookupService,
        ...
        self.sendLinkToDocumentByEmail = function (searchedIncomingDocument, $event) {
            downloadService.getMainDocumentEmailContent(searchedIncomingDocument.vsId).then(function (result) {
        ...
        self.sendCompositeDocumentAsAttachmentByEmail = function (searchedIncomingDocument, $event) {
            downloadService.getCompositeDocumentEmailContent(searchedIncomingDocument.vsId).then(function (result) {
                dialog.successMessage(langService.get('right_click_and_save_link_as') + langService.get('download_message_file').change({
                    result: result,
                    filename: 'Tawasol.msg'
                }));
