module.exports = function (app) {
    app.controller('deletedInternalCtrl', function (contextHelpService,
        ...
        self.viewDocument = function (correspondence, $event) {
            ...
            correspondence.viewFromDeletedQueue(self.gridActions, 'deletedInternal', $event, true)
                .then(function () {
        ...
        self.removePermanentlyBulk = function ($event) {
            correspondenceService
                .removePermanentlyBulkCorrespondences(self.selectedDeletedInternals, $event)
                .then(function () {
                    self.reloadDeletedInternals(self.grid.page);
                });
        };
