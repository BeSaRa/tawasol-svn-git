    ...
    app.controller('readyToExportArchiveCtrl', function (lookupService,
        ...
        self.grid = {
            ...
            selectRowsCallback: function () {
                generator.selectedRowsHandler(self.selectedWorkItems, 'readyToExport','generalStepElm.vsId');
            }
        };
        ...
        self.launchDistributionWorkflow = function (workItem, $event, defer) {
            ...
            workItem.recordGridName = gridService.grids.centralArchive.readyToExport;
