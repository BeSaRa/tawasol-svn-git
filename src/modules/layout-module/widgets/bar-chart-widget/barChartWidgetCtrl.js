module.exports = function (app) {
    app.controller('barChartWidgetCtrl', function ($scope, langService, $timeout, LayoutWidgetOption) {
        'ngInject';
        var self = this;
        self.controllerName = 'barChartWidgetCtrl';

        self.options = angular.extend({
            arName: new LayoutWidgetOption({
                optionValue: langService.getKey('bar_chart', 'ar'),
                optionKey: 'arName'
            }),
            enName: new LayoutWidgetOption({
                optionValue: langService.getKey('bar_chart', 'en'),
                optionKey: 'enName'
            })
        }, $scope.options);
