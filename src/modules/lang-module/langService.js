    ...
    app.service('langService', function (Language, CMSModelInterceptor, $timeout, titleService, cmsTemplate, $window, $rootScope, Localization, generator, $http, urlService, $q, $cookies, _) {
        ...
        self.langKeys = {
            ar: {
                ...
                server_name_ip: 'IPإسم الخادم أو',
                domain_controller_name: 'اسم وحدة تحكم النطاق',
                add_new_entity: 'أضافة جهة جديدة',
                tawasol_ou: 'وحدة تنظيم تواصل',
                test_connection: 'أختبار الأتصال',
                filenet: 'FileNet',
                filenet_content_manager_username: 'اسم المستخدم',
                filenet_content_manager_password: 'كلمة مرور مدير المحتوى',
                filenet_content_manager_ejb_address: 'EJBعنوان مدير محتوي',
                filenet_content_manager_stanza: 'Stanza مدير المحتوي',
                filenet_object_store_name: 'إسم تخزين الموضوع',
                filenet_process_engine_router_name: 'إسم مسير معالجة المحرك',
                ...
                ldap_providers: 'موفرين LDAP',
                server_name: 'إسم الخادم',
                server_host: 'معرف السيرفر',
                default_ldap: 'الافتراضي LDAP',
                actions: 'الاجراءات',
                add_ldap:'أضف LDAP',
                enter_password_to_override: 'أدخل كلمة السر للتجاوز',
                short: 'قصير جداً',
                use_ssl: 'SSL إستخدم تشفير',
                set: 'تعيين',
                reset: 'إعادة تعيين',
            ...
            en: {
                ...
                server_host: 'Server Description',
                default_ldap: 'Default LDAP',
                actions: 'Actions',
                add_ldap:'Add LDAP',
                enter_password_to_override: 'Enter the password to override',
