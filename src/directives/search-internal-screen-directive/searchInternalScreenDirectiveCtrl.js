module.exports = function (app) {
    app.controller('searchInternalScreenDirectiveCtrl', function (searchInternalService,
        ...
        self.docTypes = correspondenceService.getLookup('internal', 'docTypes');
         ...
         * @param searchedInternalDocument
         */
        self.mergeAndDownloadFullDocument = function (searchedInternalDocument) {
            downloadService.mergeAndDownload(searchedInternalDocument);
        };
                    ...
                    // Content
                    {
                        ...
                        checkShow: function (action, model) {
                            ...
                            if (info.docStatus === 23)
                                return false;
                            var hasPermission = employeeService.hasPermissionTo("EDIT_INTERNAL_CONTENT");
